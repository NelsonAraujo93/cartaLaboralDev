...
module.exports = (formulario) => {
    ...
    if(formulario.mailState===1){
        ...
        const petition = {
            ...
            html: 'Hola <strong>'+ formulario.name +'</strong>Te informamos que tu petición ha sido enviada a nuestra aplicación si quieres conocer el estado de tu petición dale click a <a href="http://localhost:3000/new-details/'+formulario.id+'">este link</a><br><br><br><br>'+
            'Atentamente: <strong>Metrolinea </strong>'
        }
